...
const styles = StyleSheet.create({
  ...
  heroWeek: { fontSize:22, fontFamily:'Inter_700Bold', color:'#fff', marginBottom:16 },
  statsRow: { flexDirection:'row', justifyContent:'space-around', marginBottom:20 },
  statItem: { alignItems:'center' },
  statVal: { fontSize:20, fontFamily:'Inter_700Bold', color:COLORS.blueLight },
  ...
  cardLabel: { fontFamily:'Inter_500Medium', fontSize:11, letterSpacing:0.5, color:'#4d6278', marginBottom:12 },
  sessionDots: { flexDirection:'row', gap:12 },
  dot: { width:50, height:50, borderRadius:25, backgroundColor:'#080c14', borderWidth:2, borderColor:'#2a3d56', alignItems:'center', justifyContent:'center' },
  ...
  weekCell: { width:40, height:40, borderRadius:8, backgroundColor:'#080c14', borderWidth:1, borderColor:'#1e2d42', alignItems:'center', justifyContent:'center' },
  ...
  weekCellTextCurrent: { color:COLORS.blueLight, fontFamily:'Inter_700Bold' },
  ...
  exitBtn: { backgroundColor:'#0f1520', borderRadius:8, paddingHorizontal:14, paddingVertical:8 },
  ...
  playerPhaseName: { fontFamily:'Inter_700Bold', fontSize:28 },
  ...
  nextUpCard: { backgroundColor:'#0f1520', borderRadius:10, paddingHorizontal:20, paddingVertical:12, borderWidth:1, borderColor:'#1e2d42', alignItems:'center' },
  nextUpLabel: { fontSize:9, color:COLORS.muted, letterSpacing:2 },
  nextUpVal: { fontSize:14, color:COLORS.text, marginTop:2, fontFamily:'Inter_600SemiBold' },
  playerControls: { padding:24, paddingBottom:40 },
  playBtn: { borderRadius:14, padding:20, alignItems:'center' },
  playBtnText: { color:'#fff', fontSize:18, fontFamily:'Inter_700Bold' },
  doneContainer: { flex:1, backgroundColor:'#0d2018', alignItems:'center', justifyContent:'center', padding:32 },
  doneEmoji: { fontSize:64, marginBottom:16 },
  doneTitle: { fontFamily:'Inter_700Bold', fontSize:28, color:COLORS.green, marginBottom:8 },
