...
const styles = StyleSheet.create({
  ...
  feedItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0f1520', borderRadius: 14, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: '#1e2d42', gap: 12 },
  ...
  cheerBtn: { padding: 8, borderRadius: 10, backgroundColor: '#080c14', borderWidth: 1, borderColor: '#1e2d42', alignItems: 'center', minWidth: 44 },
  ...
  optInContainer: { flex: 1, backgroundColor: '#080c14', padding: 24, paddingTop: 80, alignItems: 'center' },
  ...
  optInFeatureRow: { backgroundColor: '#0f1520', borderRadius: 10, padding: 14, borderWidth: 1, borderColor: COLORS.border },
