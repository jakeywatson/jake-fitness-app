...
const styles = StyleSheet.create({
  ...
  heroCard: { backgroundColor: COLORS.card, borderRadius: 16, padding: 20, marginBottom: 12, borderWidth: 1, borderColor: COLORS.border, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  heroLeft: { flex: 1 },
  heroLabel: { fontSize: 10, letterSpacing: 3, color: COLORS.muted, textTransform: 'uppercase', marginBottom: 6 },
  ...
  statCard: { backgroundColor: COLORS.card, borderRadius: 12, padding: 14, borderWidth: 1, borderColor: COLORS.border, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  ...
  goalRow: { backgroundColor: COLORS.card, borderRadius: 8, padding: 10, borderWidth: 1, borderColor: COLORS.greenDark },
  goalText: { fontSize: 13, color: COLORS.text },
  burnsCard: { backgroundColor: COLORS.card, borderRadius: 14, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: COLORS.border },
  burnsTitle: { fontSize: 10, letterSpacing: 3, color: COLORS.muted, textTransform: 'uppercase', marginBottom: 12 },
  ...
  infoCard: { backgroundColor: COLORS.card, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: COLORS.border },
  infoTitle: { fontSize: 10, letterSpacing: 3, color: COLORS.muted, textTransform: 'uppercase', marginBottom: 10 },
