...
const styles = StyleSheet.create({
  ...
  sectionLabel: { fontFamily:'Inter_500Medium', fontSize:11, letterSpacing:0.5, color:'#4d6278', textTransform: 'uppercase', marginBottom: 8, marginLeft: 4 },
  card: { backgroundColor: '#0f1520', borderRadius: 14, borderWidth: 1, borderColor: '#1e2d42', overflow: 'hidden' },
  ...
  connectBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: '#1e2d42', backgroundColor: COLORS.bg },
  ...
  signOutBtn: { borderWidth: 1, borderColor: '#1e2d42', borderRadius: 12, padding: 16, alignItems: 'center', marginBottom: 16 },
