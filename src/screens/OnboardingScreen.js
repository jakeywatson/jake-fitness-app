...
const styles = StyleSheet.create({
  ...
  featureRow: { flexDirection: 'row', gap: 14, backgroundColor: '#0f1520', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: '#1e2d42', alignItems: 'center' },
  ...
  input: { backgroundColor: '#0f1520', borderWidth: 1, borderColor: '#1e2d42', borderRadius: 10, color: COLORS.text, padding: 16, fontSize: 18, fontWeight: '600', textAlign: 'center' },
  hint: { fontSize: 13, color: COLORS.dim, textAlign: 'center', marginTop: 12, lineHeight: 20 },
  optionsList: { gap: 10 },
  optionCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0f1520', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: COLORS.border },
  ...
  radioOuter: { width: 22, height: 22, borderRadius: 11, borderWidth: 2, borderColor: '#2a3d56', alignItems: 'center', justifyContent: 'center' },
  ...
  summaryNote: { marginTop: 20, backgroundColor: '#0f1520', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: COLORS.border },
  ...
  backBtn: { flex: 1, padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#1e2d42', alignItems: 'center' },
