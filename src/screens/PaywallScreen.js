...
const styles = StyleSheet.create({
  ...
  compCardFree: { backgroundColor: COLORS.card, borderColor: COLORS.border },
  ...
  planCardMonthly: { backgroundColor: COLORS.card, borderRadius: 12, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: COLORS.border, flexDirection: 'row', justifyContent: 'space-between' },
