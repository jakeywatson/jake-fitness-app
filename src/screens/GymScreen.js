...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor:'#0f1520', borderRadius:12, marginBottom:10, borderWidth:1, borderColor:'#1e2d42', overflow:'hidden' },
  cardDone: { backgroundColor:COLORS.greenBg, borderColor:COLORS.greenDark },
  cardOpen: { borderColor:COLORS.purple },
  cardHeader: { flexDirection:'row', alignItems:'center', gap:12, padding:14 },
  exEmoji: { fontSize:22 },
  exInfo: { flex:1 },
  exName: { fontSize:14, fontFamily:'Inter_700Bold', color:COLORS.text },
  ...
  howNum: { fontSize:11, color:COLORS.purple, fontFamily:'Inter_700Bold', minWidth:16 },
  ...
  targetRow: { backgroundColor:'#080c14', borderRadius:8, padding:12, marginBottom:14, flexDirection:'row', justifyContent:'space-between', alignItems:'center' },
  targetLabel: { fontSize:11, color:COLORS.muted },
  targetVal: { fontSize:16, fontFamily:'Inter_700Bold', color:COLORS.purpleLight },
  setsRow: { flexDirection:'row', gap:8, marginBottom:8 },
  setBtn: { flex:1, padding:14, borderRadius:10, borderWidth:2, borderColor:'#1e2d42', backgroundColor:'#080c14', alignItems:'center' },
  setBtnDone: { borderColor:COLORS.purple, backgroundColor:COLORS.purpleDark },
  setBtnText: { fontSize:12, color:COLORS.dim, fontFamily:'Inter_700Bold' },
