...
const styles = StyleSheet.create({
  ...
  pageTitle:{fontFamily:'Inter_700Bold', fontSize:28,color:COLORS.text,marginBottom:16},
  ...
  woCard:{backgroundColor:'#0f1520',borderRadius:12,padding:14,marginBottom:10,borderWidth:1,borderColor:COLORS.border},
  ...
  woName:{fontSize:14,fontFamily:'Inter_700Bold',color:COLORS.text},
  ...
  pill:{flexDirection:'row',alignItems:'center',gap:4,backgroundColor:'#080c14',borderRadius:8,paddingHorizontal:8,paddingVertical:4,borderWidth:1,borderColor:COLORS.border},
  ...
  playWorkoutBtnText:{color:'#fff',fontSize:13,fontFamily:'Inter_700Bold'},
  logOnlyBtn:{flex:1,padding:12,borderRadius:10,borderWidth:1,borderColor:'#2a3d56',alignItems:'center'},
  ...
  exitBtn:{backgroundColor:'#0f1520',borderRadius:8,paddingHorizontal:12,paddingVertical:8},
  ...
  doneTitle:{fontSize:26,fontFamily:'Inter_700Bold',color:COLORS.green,marginBottom:8},
  ...
  warmupTitle:{fontSize:22,fontFamily:'Inter_700Bold',color:COLORS.text,marginBottom:8},
  warmupSub:{fontSize:16,color:COLORS.blueLight,fontFamily:'Inter_700Bold'},
  restLabel:{fontSize:13,color:COLORS.blue,letterSpacing:3,textTransform:'uppercase',textAlign:'center',marginBottom:14},
  nextCard:{backgroundColor:'#0f1520',borderRadius:12,padding:16,borderWidth:1,borderColor:COLORS.blueDark,alignItems:'center',width:'100%'},
  nextName:{fontSize:18,fontFamily:'Inter_700Bold',color:COLORS.blueLight,marginBottom:8},
  ...
  moveName:{fontSize:22,fontFamily:'Inter_700Bold',marginBottom:10},
  visualCard:{backgroundColor:'#0f1520',borderRadius:12,padding:14,marginBottom:8,borderWidth:1,width:'100%'},
  ...
  modBtn:{borderWidth:1,borderColor:'#2a3d56',borderRadius:8,paddingHorizontal:14,paddingVertical:6},
  ...
  bigTimer:{fontSize:80,fontFamily:'Inter_700Bold',lineHeight:80},
  ...
  playBtnText:{color:'#fff',fontSize:16,fontFamily:'Inter_700Bold'},
  skipBtn:{padding:18,borderRadius:12,borderWidth:1,borderColor:'#2a3d56',alignItems:'center'},
