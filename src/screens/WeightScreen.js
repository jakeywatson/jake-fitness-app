  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.row}>
          <Text style={styles.chartStat}>Best: <Text style={{color:COLORS.green,fontWeight:'700'}}>{lbsToStone(lowest)}</Text></Text>
...
const styles = StyleSheet.create({
  ...
  statCardVal: { fontSize:16, fontWeight:'700' },
  progressTrack: { height:8, backgroundColor:COLORS.bg, borderRadius:4, overflow:'hidden', marginVertical:6 },
  progressFill: { height:8, borderRadius:4, backgroundColor:COLORS.green },
  progressEnd: { fontSize:10, color:COLORS.dim },
  pctText: { fontSize:14, fontWeight:'700', color:COLORS.green },
  ...
  unitBtn: { flex:1, padding:10, borderRadius:8, borderWidth:1, borderColor:COLORS.border2, alignItems:'center', backgroundColor:COLORS.bg },
  ...
  inputWrap: { flex:1 },
  inputLabel: { fontSize:10, color:COLORS.muted, marginBottom:4 },
  input: { backgroundColor:COLORS.bg, borderWidth:1, borderColor:COLORS.border2, borderRadius:8, color:COLORS.text, padding:12, fontSize:14 },
  logBtn: { backgroundColor:COLORS.blueDark, borderRadius:10, padding:14, alignItems:'center' },
  logBtnText: { color:COLORS.blueLight, fontSize:14, fontWeight:'700' },
  milestoneRow: { flexDirection:'row', alignItems:'center', gap:12, marginTop:10 },
  milestoneDot: { width:20, height:20, borderRadius:10, backgroundColor:COLORS.bg, borderWidth:2, borderColor:COLORS.border2, alignItems:'center', justifyContent:'center' },
  milestoneDotDone: { backgroundColor:COLORS.greenDark, borderColor:COLORS.green },
  milestoneTick: { fontSize:10, color:'#fff' },
  milestoneLabel: { fontSize:13, color:COLORS.dim, flex:1 },
  ...
  entryWeight: { fontSize:15, fontWeight:'600', color:COLORS.text, marginTop:2 },
